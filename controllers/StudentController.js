...
// GET ALL STUDENTS -> 
// min/max (by id value) && start/limit (return certain number of students) queries included
student.get("/", (req, res) => {
  ...
  if(start || limit){
    ...
    const maxNumOfStudentsAllowed = (students.length - startLimit) +1
